        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="u_username" name="u_username" value="<?php echo $data['u_username']; ?>" required placeholder="用户名称">
                    </div>
                </div>
                <div class="form-group">
                    <label for="u_password" class="col-sm-2 control-label">密码</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="u_password" name="u_password"  placeholder="密码">
                        <span class="help-block">不修改请留空</span></div>
                </div>
                <div class="form-group" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <label class="radio-inline">
                            <input type="radio" name="u_status" id="inlineRadio1" value="1"  <?php if ($data['u_status'] == 1) {
                                echo 'checked';
                            } ?>>
                            开启 </label>
                        <label class="radio-inline">
                            <input type="radio" name="u_status" id="inlineRadio2" value="0"  <?php if ($data['u_status'] == 0) {
                                echo 'checked';
                            } ?>>
                            关闭 </label>
                    </div>
...
<script>
    ...
    $(function() {
        ...
        getSelectVal(<?php echo $data['u_cate_2']; ?>);
