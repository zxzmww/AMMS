...
<div class="container">
    <ul class="nav nav-tabs  mb20" role="tablist">
        <li role="presentation"  class="active"><a href="{:U('/Home/Service/Listview')}"><span class="glyphicon glyphicon-list"></span> 信息列表</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <form id="form1" name="form1" method="post" class="form-inline" action="">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="s_kws_type">
                ...
                <tbody>
                    ...
                    foreach ($listview as $key => $val) {
                        ...
                        <tr >
                            ...
                            <td><a  href="<?php echo U('/Home/Service/Editview/id/' . $val['s_id']); ?>" class="btn btn-success btn-xs">编辑</a> <a target="_blank" href="<?php echo U('/Home/Service/View/id/' . $val['s_id']); ?>" class="btn btn-info btn-xs">查看</a></td>
                        </tr>
                        <?php
                    }
                    ?>
