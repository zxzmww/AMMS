        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $data['name']; ?>" required placeholder="角色名称">
                    </div>
                </div>
                <div class="form-group">
                    <label for="remark" class="col-sm-2 control-label">角色描述</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="remark" name="remark" value="<?php echo $data['remark']; ?>" placeholder="角色描述">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <label class="radio-inline">
                            <input type="radio" name="status" id="inlineRadio1" value="1" <?php
                            if ($data['status'] == 1) {
                                echo 'checked';
                            }
                            ?>>
                            开启 </label>
                        <label class="radio-inline">
                            <input type="radio" name="status" id="inlineRadio2" value="0" <?php
                            if ($data['status'] == 0) {
                                echo 'checked';
                            }
                            ?>>
